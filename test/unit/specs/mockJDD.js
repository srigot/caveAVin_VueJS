// Objets EMPLACEMENTS
export const eA2 = {rangee: 'A', colonne: '2', v4}
export const eC5 = {rangee: 'C', colonne: '5'}
export const eB5 = {rangee: 'B', colonne: '5'}

// Objets Vins
export const v1 = {_id: 1, nom: 'TEST 1', annee: 2010, emplacements: []}
export const v1Updated = {_id: 1, nom: 'TEST 1 UPDATED', annee: 2011, emplacements: []}
